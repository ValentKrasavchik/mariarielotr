...
const reviews = [
  {
    clientName: "Анна К.",
    text: "Мария спокойно провела нас через продажу квартиры: подготовила документы, помогла с показами и защитила нашу цену на переговорах.",
    rating: 5,
    date: new Date("2026-02-12"),
  },
  {
    clientName: "Илья и Марина",
    text: "Искали квартиру для семьи и боялись ошибиться с районом. Получили понятный подбор, честные комментарии по каждому объекту и уверенность в сделке.",
    rating: 5,
    date: new Date("2026-01-18"),
  },
  {
    clientName: "Сергей П.",
    text: "Понравилось, что Мария заранее проверила риски по документам и объяснила все простым языком. Сделка прошла без лишней суеты.",
    rating: 5,
    date: new Date("2025-12-03"),
  },
  {
    clientName: "Елена",
    text: "Сдала квартиру быстро и по хорошей ставке. Отдельно отмечу аккуратную коммуникацию с арендаторами и внимание к деталям.",
    rating: 5,
...
async function main() {
  ...
  if (!settings) {
    await prisma.siteSettings.create({ data: regionDefaults });
  } else {
