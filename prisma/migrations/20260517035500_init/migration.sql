...
CREATE TABLE "SiteSettings" (
    ...
    "heroSubtitle" TEXT NOT NULL DEFAULT 'Недвижимость с заботой о результате',
    "heroText" TEXT NOT NULL DEFAULT 'Помогаю купить, продать и подобрать недвижимость в Москве и области с полным сопровождением сделки.',
    "aboutText" TEXT NOT NULL DEFAULT 'Мария помогает клиентам безопасно покупать, продавать и подбирать недвижимость. В работе важны прозрачность, внимательность к деталям и спокойное сопровождение клиента на каждом этапе сделки.',
    "seoTitle" TEXT NOT NULL DEFAULT 'Мария Риелтор - недвижимость в Москве и области',
    "seoDescription" TEXT NOT NULL DEFAULT 'Персональный сайт риелтора Марии: актуальные объекты, сопровождение покупки и продажи недвижимости, консультации по рынку.',
    "workTime" TEXT NOT NULL DEFAULT 'Ежедневно с 10:00 до 20:00',
    "region" TEXT NOT NULL DEFAULT 'Москва и Московская область',
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL
);
